...
class Receipt(models.Model):
    ...
    object_storage_bucket = models.CharField(max_length=128, blank=True)
    object_storage_key = models.CharField(max_length=512, blank=True)
    object_storage_etag = models.CharField(max_length=128, blank=True)
